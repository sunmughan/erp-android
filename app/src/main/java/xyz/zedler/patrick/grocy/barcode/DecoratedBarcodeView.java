...
public class DecoratedBarcodeView extends FrameLayout {
    private xyz.zedler.patrick.grocy.barcode.BarcodeView barcodeView;
    private xyz.zedler.patrick.grocy.barcode.ViewfinderView viewFinder;
    ...
    private void initialize(AttributeSet attrs) {
        ...
        int scannerLayout = R.layout.zxing_barcode_scanner2;

        attributes.recycle();

        inflate(getContext(), scannerLayout, this);

        barcodeView = findViewById(R.id.zxing_barcode_surface2);
        ...
        viewFinder = findViewById(R.id.zxing_viewfinder_view2);
        ...
        statusView = findViewById(R.id.zxing_status_view2);
    }
    ...
    public xyz.zedler.patrick.grocy.barcode.BarcodeView getBarcodeView() {
        return findViewById(R.id.zxing_barcode_surface2);
    }
