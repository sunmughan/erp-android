...
public final class CameraManager {
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            ...
            if (cameraResolution != null && callback != null) {
                try {
                    ...
                    xyz.zedler.patrick.grocy.barcode.SourceData source = new SourceData(data, cameraResolution.width, cameraResolution.height, format, getCameraRotation());
    ...
    public void startPreview() {
        ...
        if (theCamera != null && !previewing) {
            ...
            ambientLightManager = new xyz.zedler.patrick.grocy.barcode.AmbientLightManager(context, this, settings);
