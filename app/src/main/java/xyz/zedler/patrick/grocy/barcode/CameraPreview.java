...
public class CameraPreview extends ViewGroup {
    ...
    public void pauseAndWait() {
        xyz.zedler.patrick.grocy.barcode.CameraInstance instance = getCameraInstance();
        pause();
     ...
     */
    protected xyz.zedler.patrick.grocy.barcode.CameraInstance createCameraInstance() {
        xyz.zedler.patrick.grocy.barcode.CameraInstance cameraInstance = new xyz.zedler.patrick.grocy.barcode.CameraInstance(getContext());
     ...
     * @see #isPreviewActive()
     */
    public xyz.zedler.patrick.grocy.barcode.CameraInstance getCameraInstance() {
        return cameraInstance;
    }
