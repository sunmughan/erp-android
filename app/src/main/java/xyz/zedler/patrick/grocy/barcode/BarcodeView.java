 ...
 */
public class BarcodeView extends xyz.zedler.patrick.grocy.barcode.CameraPreview {
    ...
    private void startDecoderThread() {
        ...
        if (decodeMode != DecodeMode.NONE && isPreviewActive()) {
            ...
            decoderThread = new xyz.zedler.patrick.grocy.barcode.DecoderThread(getCameraInstance(), createDecoder(), resultHandler);
